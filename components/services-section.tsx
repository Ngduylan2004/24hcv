...
const services = [
  ...
  },
  {
    ...
    description: "Sắp xếp, phân loại và lập hồ sơ lưu trữ theo tiêu chuẩn quốc gia.",
    features: ["Phân loại hồ sơ", "Lập mục lục", "Đánh số ký hiệu", "Bảo quản tài liệu"],
  ...
  },
  {
    ...
    description: "Cung cấp và cho thuê thiết bị CNTT, hộp kệ lưu trữ chất lượng cao.",
