...
const stats = [
  {
    ...
    description: "Dự án triển khai thành công tại Việt Nam",
  ...
  },
  {
    ...
    suffix: "+",
    label: "Khách Hàng",
    description: "Doanh nghiệp, cơ quan chính phủ tin tưởng",
  ...
  },
  {
    ...
    description: "Hoạt động liên tục trong ngành CNTT",
  ...
  },
  {
    ...
    suffix: "+",
    label: "Chuyên Gia",
    description: "Đội ngũ kỹ sư và chuyên gia công nghệ",
  ...
  },
  {
    ...
    description: "Khách hàng đánh giá cao chất lượng dịch vụ",
  ...
  },
  {
    ...
    description: "Đã được số hóa và lưu trữ an toàn",
